    ...
    (e = "function" == typeof define && define.amd),
        ...
        (m = {
            init: function (r) {
                ...
                return (
                    ...
                    (r.mouseWheel.normalizeDelta = r.advanced
                        .normalizeMouseWheelDelta
                        ? r.advanced.normalizeMouseWheelDelta
                        : r.mouseWheel.normalizeDelta),
                    (r.scrollButtons.scrollType = f(
                        r.scrollButtons.scrollType
                    )),
                    s(r),
                    z(e).each(function () {
                        var e = z(this);
            ...
            destroy: function () {
                ...
                return z(r).each(function () {
                    ...
                    if (e.data(H)) {
                        ...
                        o.live && d(o.liveSelector || z(r).selector),
                            G.call(this, "remove"),
                            T.call(this),
                            y.call(this),
                            e.removeData(H),
            ...
            "y" === o.axis ||
                ...
                "outside" === o.scrollbarPosition
                    ? ("static" === e.css("position") &&
                      ...
                      d.addClass("mCSB_outside").after(r))
                    : (d.addClass("mCSB_inside").append(r), u.wrap(l)),
                _.call(this);
            var f = [
                z("#mCSB_" + t.idx + "_dragger_vertical"),
                z("#mCSB_" + t.idx + "_dragger_horizontal"),
                ...
                (2 !== o.advanced.autoExpandHorizontalScroll &&
                    ...
                    : a
                          ...
                          .css({
                              width:
                                  Math.ceil(
                                      a[0].getBoundingClientRect().right + 0.4
                                  ) -
                                  Math.floor(a[0].getBoundingClientRect().left),
                              "min-width": "100%",
                              position: "relative",
                          })
                          .unwrap();
        ...
        (_ = function () {
            var e = z(this),
                t = e.data(H),
                o = t.opt,
                a = z(".mCSB_" + t.idx + "_scrollbar:first"),
                n = ne(o.scrollButtons.tabindex)
        ...
        (w = function () {
            ...
            n[0]
                ...
                n[1].css({ width: s, "max-width": n[1].parent().width() - 10 });
        }),
        (b = function () {
            var e = z(this),
                t = e.data(H),
        ...
        (k = function (e, t, o) {
            ...
            "active" === t
                ...
                : e[0]._draggable ||
                  ("hide" === t
                      ? (e.removeClass(S[0]), n.removeClass(S[1]))
                      : (e.addClass(S[0]), n.addClass(S[1])));
        }),
        (C = function () {
            var e = z(this),
                t = e.data(H),
        ...
        (y = function () {
            ...
            if (
                ...
                (("x" !== o.axis && !t.overflowed[0]) ||
                    ...
                    (i[0].add(n).css("top", 0), K(e, "_resetY")),
                ("y" !== o.axis && !t.overflowed[1]) ||
                    ("x" === o.axis && t.overflowed[1]))
            ) {
                var r = (dx = 0);
                "rtl" === t.langDir &&
                    ((r = a.width() - n.outerWidth(!1)),
                ...
                if (
                    ...
                    !(function e() {
                        a = setTimeout(function () {
                            z.event.special.mousewheel
                                ? (clearTimeout(a), D.call(t[0]))
                                : e();
                        }, 100);
                    })();
                A.call(this),
                    j.call(this),
                    o.advanced.autoScrollOnFocus && L.call(this),
                    o.scrollButtons.enable && Y.call(this),
                    o.keyboard.enable && X.call(this),
                    (e.bindEvents = !0);
            }
        }),
        (T = function () {
                ...
                (o.overflowed[0] && !e
                    ...
                    : (a.alwaysShowScrollbar
                          ? (2 !== a.alwaysShowScrollbar &&
                            ...
                            i.removeClass(S[10]))
                          : (r[0].css("display", "none"), i.addClass(S[10])),
                      i.addClass(S[8]))),
                "y" !== a.axis &&
                    (o.overflowed[1] && !e
                        ? (r[1]
        ...
        (F = function (e) {
            ...
            switch (t) {
                ...
                case "MSPointerUp":
                    return o
                        ? [
                              e.originalEvent.pageY - o[0] + a[0],
                              e.originalEvent.pageX - o[1] + a[1],
                              !1,
                          ]
                ...
                case "touchend":
                    ...
                    return e.target.ownerDocument !== document
                        ? [n.screenY, n.screenX, 1 < i]
                        : [n.pageY, n.pageX, 1 < i];
                default:
                    return o
                        ? [e.pageY - o[0] + a[0], e.pageX - o[1] + a[1], !1]
                        : [e.pageY, e.pageX, !1];
            }
        }),
        (r = function () {
            var r,
                ...
                o = u.advanced.releaseDraggableSelectors
                    ...
                    : t,
                a = u.advanced.extraDraggableSelectors
                    ? z(!q() || top.document).add(
                          z(u.advanced.extraDraggableSelectors)
                      )
                    : z(!q() || top.document);
            function n(e, t, o, a) {
                if (
                    ((h[0].idleTimer = u.scrollInertia < 233 ? 250 : 0),
                    r.attr("id") === f[1])
                )
                    var n = "x",
                    ...
                    function (e) {
                        if (
                            ...
                            o < n &&
                                ...
                                0 < a &&
                                ((l = o), (s = a)),
                                k(r, "active", u.autoExpandScrollbar);
                        }
                    }
                )
        ...
        (O = function () {
            var d,
                ...
                M = [
                    z("#mCSB_" + y.idx + "_dragger_vertical"),
                    z("#mCSB_" + y.idx + "_dragger_horizontal"),
                ],
                O = [],
                I = [],
                D = 0,
            ...
            function a(e) {
                if (!ae(e) || U || F(e)[2]) P = 0;
                    ...
                    (b = S = 0), (d = P = 1), C.removeClass("mCS_touch_action");
                    var t = k.offset();
                    (c = F(e)[0] - t.top),
                        (u = F(e)[1] - t.left),
                        (W = [F(e)[0], F(e)[1]]);
            ...
            function n(e) {
                if (
                    ...
                    if (
                        (O.push(o),
                        I.push(a),
                        (W[2] = Math.abs(F(e)[0] - W[0])),
                        (W[3] = Math.abs(F(e)[1] - W[1])),
                        y.overflowed[0])
                    )
                        var i = M[0].parent().height() - M[0].height(),
                            r =
                                0 < c - o &&
                                o - c > -i * y.scrollRatio.y &&
                                (2 * W[3] < W[2] || "yx" === B.axis);
                    if (y.overflowed[1])
                    ...
                    r || s
                        ...
                        (_ =
                            "yx" === B.axis
                                ...
                                : [c - o, null]),
                        (k[0].idleTimer = 250),
                        y.overflowed[0] && L(_[0], D, n, "y", "all", !0),
                        y.overflowed[1] && L(_[1], D, n, "x", E, !0);
                }
            }
            function i(e) {
                if (!ae(e) || U || F(e)[2]) P = 0;
                else {
                    (P = 1), e.stopImmediatePropagation(), J(C), (m = $());
                    var t = T.offset();
                    (f = F(e)[0] - t.top),
                        (h = F(e)[1] - t.left),
                        (O = []),
                ...
                if (ae(e) && !U && !F(e)[2]) {
                    ...
                    if (!(30 < g - p)) {
                        ...
                        x = i
                            ...
                            : [x, x];
                        var s = [
                            Math.abs(k[0].offsetTop) -
                                v[0] * A(l[0] / x[0], x[0]),
                            Math.abs(k[0].offsetLeft) -
                                v[1] * A(l[1] / x[1], x[1]),
                        ];
                        (_ =
                            "yx" === B.axis
                                ...
                                : [s[0], null]),
                            (w = [
                                4 * l[0] + B.scrollInertia,
                                4 * l[1] + B.scrollInertia,
                            ]);
                        var c = parseInt(B.contentTouchScroll) || 0;
                        (_[0] = c < l[0] ? _[0] : 0),
                            (_[1] = c < l[1] ? _[1] : 0),
                            y.overflowed[0] && L(_[0], w[0], n, "y", E, !1),
                            y.overflowed[1] && L(_[1], w[1], n, "x", E, !1);
                    }
                }
            }
            function A(e, t) {
        ...
        (I = function () {
            ...
            function d(e, t, o) {
                (l.type = o && n ? "stepped" : "stepless"),
                    (l.scrollAmount = 10),
                    N(a, e, t, "mcsLinearOut", o ? 60 : null);
            }
            s.bind("mousedown." + e, function (e) {
                ...
                .bind("mousemove." + e, function (e) {
                    if (
                        ...
                        0 < o && o < c.height() && 0 < a && a < c.width()
                            ? l.step && d("off", null, "stepped")
                            : ("x" !== r.axis &&
                                  i.overflowed[0] &&
                                  (o < 0
                                      ? d("on", 38)
        ...
        (D = function () {
            if (z(this).data(H)) {
                var u = z(this),
                    ...
                    m = z("#mCSB_" + f.idx),
                    p = [
                        z("#mCSB_" + f.idx + "_dragger_vertical"),
                        z("#mCSB_" + f.idx + "_dragger_horizontal"),
                    ],
                ...
                if ((J(u), !R(u, e.target))) {
                        ...
                        var n = "x",
                            ...
                            r =
                                "auto" !== h.mouseWheel.scrollAmount
                                    ...
                                    : i[0],
                            l = Math.abs(
                                z("#mCSB_" + f.idx + "_container")[0].offsetLeft
                            ),
                            s = p[1][0].offsetLeft,
                        ...
                        var n = "y",
                            ...
                            r =
                                "auto" !== h.mouseWheel.scrollAmount
                                    ...
                                    : i[0],
                            l = Math.abs(
                                z("#mCSB_" + f.idx + "_container")[0].offsetTop
                            ),
                            s = p[0][0].offsetTop,
                    ...
                    ("y" === n && !f.overflowed[0]) ||
                        ...
                        ((h.mouseWheel.invert ||
                            ...
                            (d = -d),
                        h.mouseWheel.normalizeDelta && (d = d < 0 ? -1 : 1),
                        ((0 < d && 0 !== s) ||
                            (d < 0 && s !== c) ||
                        ...
                        e.deltaFactor < 5 &&
                            ...
                            ((r = e.deltaFactor), (a = 17)),
                        K(u, (l - d * r).toString(), { dir: n, dur: a }));
                }
            }
        }),
        (E = new Object()),
        ...
        (R = function (e, t) {
            var o = t.nodeName.toLowerCase(),
                a = e.data(H).opt.mouseWheel.disableOver;
            return (
                -1 < z.inArray(o, a) &&
                !(
        ...
        (A = function () {
            ...
            t.bind(
                "mousedown." +
                    ...
                    e,
                function (e) {
                    (U = !0), z(e.target).hasClass("mCSB_dragger") || (r = 1);
                }
            )
                .bind(
                    "touchend." + e + " pointerup." + e + " MSPointerUp." + e,
                ...
                .bind("click." + e, function (e) {
                    if (
                        ...
                        if (
                            0 < t.parent(".mCSB_scrollTools_horizontal").length
                        ) {
        ...
        (L = function () {
            ...
            l.bind("focusin." + t, function (e) {
                ...
                n.is(r.advanced.autoScrollOnFocus) &&
                    (J(i),
                    clearTimeout(i[0]._focusTimeout),
                    (i[0]._focusTimer = t ? 17 * t : 0),
                    (i[0]._focusTimeout = setTimeout(function () {
                        var e = [ie(n)[0], ie(n)[1]],
                            ...
                            o = [
                                0 <= t[0] + e[0] &&
                                    t[0] + e[0] <
                                        s.height() - n.outerHeight(!1),
                                0 <= t[1] + e[1] &&
                                    t[0] + e[1] < s.width() - n.outerWidth(!1),
                            ],
                            a =
                                "yx" !== r.axis || o[0] || o[1]
                                    ? "all"
        ...
        (j = function () {
            var e = z(this),
                t = e.data(H),
                o = H + "_" + t.idx,
                a = z("#mCSB_" + t.idx + "_container").parent();
            a.bind("scroll." + o, function (e) {
                (0 === a.scrollTop() && 0 === a.scrollLeft()) ||
                    z(".mCSB_" + t.idx + "_scrollbar").css(
                        "visibility",
                        "hidden"
                    );
            });
            ...
            o.bind("contextmenu." + e, function (e) {
                ...
                function (e) {
                    if ((e.preventDefault(), oe(e))) {
                        ...
                        switch (
                            ((r.type = i.scrollButtons.scrollType), e.type)
                        ) {
                            case "mousedown":
                            case "touchstart":
                            case "pointerdown":
                            ...
                            case "MSPointerOut":
                                ...
                                break;
                            case "click":
                                if ("stepped" !== r.type || n.tweenRunning)
                                    return;
                                o("on", t);
                        }
                    }
                    function o(e, t) {
                        (r.scrollAmount = i.scrollButtons.scrollAmount),
                            N(a, e, t);
                    }
                }
            );
            ...
            function n(e) {
                switch (e.type) {
                    ...
                    case "keyup":
                        ...
                        if (
                            ...
                            if (
                                ((38 === t || 40 === t) && !s.overflowed[0]) ||
                                ((37 === t || 39 === t) && !s.overflowed[1])
                            )
                                return;
                            "keyup" === e.type && (o = "off"),
                                z(document.activeElement).is(h) ||
                                    (e.preventDefault(),
                                    e.stopImmediatePropagation(),
                                    r(o, t));
                        } else if (33 === t || 34 === t) {
                ...
                function r(e, t) {
                    (d.type = c.keyboard.scrollType),
                        ...
                        ("stepped" === d.type && s.tweenRunning) || N(l, e, t);
                }
            }
            o.length &&
                o.each(function () {
        ...
        (N = function (u, e, t, f, h) {
            ...
            switch (e) {
                case "on":
                    if (
                        ((g.dir = [
                            t === S[16] || t === S[15] || 39 === t || 37 === t
                                ? "x"
                                : "y",
                            t === S[13] || t === S[15] || 38 === t || 37 === t
                                ? -1
                                : 1,
                        ]),
                        J(u),
                ...
                case "off":
                    clearTimeout(g.step),
                        te(g, "step"),
                        J(u),
                        (o || (m.tweenRunning && g.dir)) && w(!0);
            }
            function w(e) {
                p.snapAmount &&
                    (g.scrollAmount =
                        p.snapAmount instanceof Array
                            ? "x" === g.dir[0]
                                ? p.snapAmount[1]
                                : p.snapAmount[0]
                            : p.snapAmount);
                var t = "stepped" !== g.type,
                    ...
                    i = [
                        10 < m.scrollRatio.y ? 10 : m.scrollRatio.y,
                        10 < m.scrollRatio.x ? 10 : m.scrollRatio.x,
                    ],
                    r =
                        "x" === g.dir[0]
                            ? n[1] + g.dir[1] * (i[1] * a)
                    ...
                    l =
                        "x" === g.dir[0]
                            ? n[1] + g.dir[1] * parseInt(g.scrollAmount)
                            : n[0] + g.dir[1] * parseInt(g.scrollAmount),
        ...
        (Q = function (e, t) {
            if (null != e && void 0 !== e) {
                ...
                var s =
                        "x" === t
                            ? i.outerWidth(!1) - r.width()
                            : i.outerHeight(!1) - r.height(),
                ...
                switch (l) {
                    ...
                    case "number":
                        ...
                        if ("bottom" === e)
                            return Math.abs(r.height() - i.outerHeight(!1));
                        if ("right" === e)
                            return Math.abs(r.width() - i.outerWidth(!1));
                        if ("first" === e || "last" === e) {
                            var u = i.find(":" + e);
                            return "x" === t ? ie(u)[1] : ie(u)[0];
                        }
        ...
        (G = function (e) {
            ...
            if (e)
                return (
                    clearTimeout(n[0].autoUpdate), void te(n[0], "autoUpdate")
                );
            function i(e) {
                              ...
                              return a.advanced.updateOnSelectorChange &&
                                  ...
                                  : !a.advanced.updateOnImageLoad ||
                                    ("auto" === a.advanced.updateOnImageLoad &&
                                        "y" === a.axis) ||
                                    ((o.poll.img.n = n.find("img").length),
                                  ...
                                  : ((o.poll.img.o = o.poll.img.n),
                                    void n.find("img").each(function () {
                                        !(function (e) {
                                            if (z(e).hasClass(S[2])) return i();
                                            var t,
                                                o,
                                                a = new Image();
                                            (a.onload =
        ...
        (K = function (n, e, i) {
            var t = n.data(H),
                ...
                i = z.extend(a, i),
                r = [i.dur, i.drag ? 0 : i.dur],
                l = z("#mCSB_" + t.idx),
                s = z("#mCSB_" + t.idx + "_container"),
                c = s.parent(),
                d = o.callbacks.onTotalScrollOffset
                    ? V.call(n, o.callbacks.onTotalScrollOffset)
                    : [0, 0],
                u = o.callbacks.onTotalScrollBackOffset
            ...
            if (
                ...
                "_resetY" !== e ||
                    t.contentReset.y ||
                    (B("onOverflowYNone") &&
                        o.callbacks.onOverflowYNone.call(n[0]),
                    (t.contentReset.y = 1)),
                "_resetX" !== e ||
                    t.contentReset.x ||
                    (B("onOverflowXNone") &&
                        o.callbacks.onOverflowXNone.call(n[0]),
                    (t.contentReset.x = 1)),
                "_resetY" !== e && "_resetX" !== e)
            ) {
                if (
                    ((!t.contentReset.y && n[0].mcs) ||
                        !t.overflowed[0] ||
                        (B("onOverflowY") && o.callbacks.onOverflowY.call(n[0]),
                        (t.contentReset.x = null)),
                    (!t.contentReset.x && n[0].mcs) ||
                        !t.overflowed[1] ||
                        (B("onOverflowX") && o.callbacks.onOverflowX.call(n[0]),
                        (t.contentReset.x = null)),
                    o.snapAmount)
                ) {
                    var f =
                    ...
                    (h = e),
                        (m = f),
                        (p = o.snapOffset),
                        (e = Math.round(h / m) * m - p);
                }
                var h, m, p;
                switch (i.dir) {
                    case "x":
                        var g = z("#mCSB_" + t.idx + "_dragger_horizontal"),
                            v = "left",
                            x = s[0].offsetLeft,
                            _ = [
                            ...
                            S = d[1],
                            b = u[1],
                            C = 0 < S ? S / t.scrollRatio.x : 0,
                            y = 0 < b ? b / t.scrollRatio.x : 0;
                        break;
                    case "y":
                        var g = z("#mCSB_" + t.idx + "_dragger_vertical"),
                            v = "top",
                            x = s[0].offsetTop,
                            _ = [
                            ...
                            S = d[0],
                            b = u[0],
                            C = 0 < S ? S / t.scrollRatio.y : 0,
                            y = 0 < b ? b / t.scrollRatio.y : 0;
                }
                w[1] < 0 || (0 === w[0] && 0 === w[1])
                    ? (w = [0, 0])
                    : w[1] >= _[1]
                    ...
                    : (w[0] = -w[0]),
                    n[0].mcs ||
                        (T(), B("onInit") && o.callbacks.onInit.call(n[0])),
                    clearTimeout(s[0].onCompleteTimeout),
                    Z(g[0], v, Math.round(w[1]), r[1], i.scrollEasing),
                    (!t.tweenRunning &&
                        ((0 === x && 0 <= w[0]) ||
                            (x === _[0] && w[0] <= _[0]))) ||
                        Z(
                            ...
                            i.overwrite,
                            {
                                onStart: function () {
                                    i.callbacks &&
                                        ...
                                        (B("onScrollStart") &&
                                            (T(),
                                            o.callbacks.onScrollStart.call(
                                                n[0]
                                            )),
                                        (t.tweenRunning = !0),
                                        k(g),
                                ...
                                onUpdate: function () {
                                    i.callbacks &&
                                        ...
                                        B("whileScrolling") &&
                                        (T(),
                                        o.callbacks.whileScrolling.call(n[0]));
                                },
                                onComplete: function () {
                                    if (i.callbacks && i.onComplete) {
                                        ...
                                        s[0].onCompleteTimeout = setTimeout(
                                            function () {
                                                B("onScroll") &&
                                                    (T(),
                                                    o.callbacks.onScroll.call(
                                                        n[0]
                                                    )),
                                                    B("onTotalScroll") &&
                                                        w[1] >= _[1] - C &&
            ...
            function B(e) {
                return (
                    t && o.callbacks[e] && "function" == typeof o.callbacks[e]
                );
            }
            function T() {
                ...
                n[0].mcs = {
                    ...
                    draggerLeft: t[1],
                    topPct: Math.round(
                        (100 * Math.abs(e[0])) / (Math.abs(o[0]) - a[0])
                    ),
                    leftPct: Math.round(
                        (100 * Math.abs(e[1])) / (Math.abs(o[1]) - a[1])
                    ),
                    direction: i.dir,
                };
            }
                                ...
                                return (
                                    ...
                                    0 <=
                                        (o = [
                                            ...
                                            ie(a)[0] &&
                                        o[0] + ie(a)[0] <
                                            t.height() - a.outerHeight(!1) &&
                                        0 <= o[1] + ie(a)[1] &&
                                        o[1] + ie(a)[1] <
                                            t.width() - a.outerWidth(!1)
                                );
                        },
                    mcsInSight:
                        z.expr[":"].mcsInSight ||
                        function (e, t, o) {
                            ...
                            if (s.length)
                                return (
                                    (a = [l.outerHeight(!1), l.outerWidth(!1)]),
                                    (i = [
                                        s[0].offsetTop + ie(l)[0],
                                        s[0].offsetLeft + ie(l)[1],
                                    ]),
                                    (n = [
...
//# sourceMappingURL=/sm/2b35b6fffeffacf623f77cbb6c6ba27284c03326ce6657f7edd9f96e0aa80102.map
