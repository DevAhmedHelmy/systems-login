...
(function (a) {
        ...
        function (a, h) {
            function p(a) {
                if ("function" === typeof l.MouseEvent)
                    return new l.MouseEvent(a.type, a);
                if (q.createEvent) {
   ...
   : Math.min(d, e.length),
                ...
                a.compose = function (c) {
                    -1 === k.indexOf(c) &&
                        (k.push(c), (c.prototype.langFormat = n));
                    return c;
                };
                a.i18nFormat = g;
            })(l || (l = {}));
    ...
    x(
        ...
        function (a, h, p) {
            function w(b, f) {
                var c = f.type,
                    e = b.hcEvents;
                n.createEvent && (b.dispatchEvent || b.fireEvent)
                    ? b.dispatchEvent
                        ? b.dispatchEvent(f)
                        : b.fireEvent(c, f)
                    : e && e[c]
                    ? d(b, c, f)
                    : b.element && w(b.element, f);
            }
            function q(b) {
                var d = b.chart,
                    c = {},
                    e = "Seconds";
                c.Seconds =
                    ((b.dataMax || b.max || 0) - (b.dataMin || b.min || 0)) /
                    1e3;
            ...
            function l(b) {
                var d = b.chart,
                    ...
                    e =
                        (c &&
                            c.accessibility &&
                            c.accessibility.screenReaderSection
                                .axisRangeDateFormat) ||
                        "",
                    a = {
                ...
                getChartTitle: function (b) {
                    return k(
                        b.options.title.text ||
                            b.langFormat("accessibility.defaultChartTitle", {
                                chart: b,
                            })
                    );
                },
    ...
    x(
        ...
        function (a, h, p, w, q) {
            var l =
                ...
                t = p.unhideChartElementFromAT,
                v = p.getChartTitle,
                g = w.doc,
                n = q.stripHTMLTagsFromString;
            return (function (a) {
                function c() {
                ...
                c.prototype.setRenderToAttrs = function () {
                    ...
                    b &&
                        ...
                        a.renderTo.setAttribute("aria-label", b));
                };
            ...
            (function (h) {
                ...
                function n(b, d) {
                    ...
                    var c = this.getBBox(),
                        f = t(b, 3),
                        e = this.parentGroup,
                        y = this.scaleX || (e && e.scaleX),
                        n = this.scaleY || (e && e.scaleY);
                    y = (y ? !n : n)
                        ? Math.abs(y || n || 1)
                        : (Math.abs(y || 1) + Math.abs(n || 1)) / 2;
                    ...
                    if ("text" === this.element.nodeName || D) {
                        ...
                        D &&
                            ...
                            (E = C),
                            (C = D),
                            isNaN(m) || (n = m - c.height * u.x - f),
                            isNaN(r) || (h = r - c.width * u.y - f));
                    }
                    this.focusBorder = this.renderer
                        .rect(
                            ...
                            E,
                            C,
                            parseInt(((d && d.r) || 0).toString(), 10) / y
                        )
                ...
                function e(b) {
                    b.focusBorderUpdateHooks &&
                        (Object.keys(b.focusBorderUpdateHooks).forEach(
                            function (d) {
                ...
                h.compose = function (b, a) {
                    -1 === d.indexOf(b) &&
                        (d.push(b),
                        (b = b.prototype),
                        (b.renderFocusBorder = l),
                        (b.setFocusToElement = v));
                    -1 === d.indexOf(a) &&
                        (d.push(a),
                        (a = a.prototype),
                        (a.addFocusBorder = n),
            ...
            return (function () {
                ...
                n.prototype.addAnnounceRegion = function (a) {
                    ...
                    this.chart.styledMode
                        ? t(e, "highcharts-visually-hidden")
                        : v(e);
                    c.appendChild(e);
                    return e;
                };
                n.prototype.createAnnouncerContainer = function () {
                    var a = this.chart,
                ...
                var n = p(a),
                    k = a.points
                        ...
                        .map(function (a) {
                            var b =
                                (a.accessibility &&
                                    a.accessibility.valueDescription) ||
                                (a.graphic &&
                                    a.graphic.element &&
                                    a.graphic.element.getAttribute(
                                        "aria-label"
                                    )) ||
                                "";
                            a = (a && a.series.name) || "";
        ...
        function (a, h, p, w, q, l, G, v, g, n) {
            function k(a, b) {
                ...
                r = {
                    ...
                    chart: a,
                    mapTitle:
                        a.mapView && a.mapView.geoMap && a.mapView.geoMap.title,
                };
                if (!d)
                    return a.langFormat(
                ...
                return (
                    (a.langFormat("accessibility.chartTypes." + b + c, r) ||
                        a.langFormat(
                            "accessibility.chartTypes.default" + c,
                            r
                        )) + (d ? " " + d : "")
                );
            }
            var c =
                ...
                e = w.getAnnotationsInfoHTML,
                d = l.getAxisDescription,
                b = l.getAxisRangeDescription,
                f = l.getChartTitle,
                y = l.unhideChartElementFromAT,
                z = G.format,
                K = v.doc,
                t = g.addClass,
                x = g.getElement,
                B = g.getHeadingTagNameForElement,
                A = g.stripHTMLTagsFromString,
                E = g.visuallyHideElement,
                C = n.attr,
                D = n.pick;
            return (function (g) {
                function u() {
                    ...
                    this.screenReaderSections = {
                        before: {
                            ...
                            buildContent: function (b) {
                                ...
                                return d
                                    ? d(b)
                                    : a.defaultBeforeChartFormatter(b);
                            },
                ...
                u.prototype.setLinkedDescriptionAttrs = function () {
                    ...
                    a &&
                        ...
                        t(a, "highcharts-linked-description"));
                };
                u.prototype.updateScreenReaderSection = function (a) {
                    ...
                    c
                        ? (this.setScreenReaderSectionAttribs(m, a),
                          q.setElementHTML(f, c),
                          m.appendChild(f),
                          d.insertIntoDOM(m, b),
                          b.styledMode
                              ? t(f, "highcharts-visually-hidden")
                              : E(f),
                          y(b, f),
                ...
                u.prototype.setScreenReaderSectionAttribs = function (a, b) {
                    ...
                    b = "highcharts-screen-reader-region-"
                        .concat(b, "-")
                        .concat(d.index);
                ...
                u.prototype.defaultBeforeChartFormatter = function () {
                    ...
                    var c = this.getAxesDescription(),
                        ...
                        u = "hc-linkto-highcharts-data-table-" + b.index,
                        y = e(b),
                        g = b.langFormat(
                    ...
                    c = {
                        ...
                        viewTableButton: b.getCSV
                            ? this.getDataTableButtonText(u)
                            : "",
                ...
                u.prototype.getLongdescText = function () {
                ...
                u.prototype.getDataTableButtonText = function (a) {
                    ...
                    b = b.langFormat(
                        ...
                        { chart: b, chartTitle: f(b) }
                    );
                    return '<button id="' + a + '">' + b + "</button>";
                };
                u.prototype.getSonifyButtonText = function (a) {
                    var b = this.chart;
                    if (
                        b.options.sonification &&
                ...
                u.prototype.focusDataTable = function () {
                    ...
                    (a = a && a.getElementsByTagName("table")[0]) &&
                        a.focus &&
                        a.focus();
                };
                u.prototype.initSonifyButton = function (a) {
                    var b = this,
                        d = (this.sonifyButton = x(a)),
                        c = this.chart,
                        f = function (a) {
                            d &&
                ...
                u.prototype.initDataTableButton = function (a) {
                    var b = (this.viewDataTableButton = x(a)),
                        d = this.chart;
                    a = a.replace("hc-linkto-", "");
                    b &&
                        (C(b, { tabindex: -1, "aria-expanded": !!x(a) }),
                        (b.onclick =
            ...
            h = (function (a) {
                    ...
                    e &&
                        ...
                        (this.exportButtonProxy = b.addProxyElement(
                            ...
                            { click: c },
                            {
                                ...
                                "aria-expanded": !1,
                                title:
                                    a.options.lang.contextButtonTitle || null,
                            }
                        ));
                };
                ...
                c.prototype.onKbdClick = function (a) {
                    var b = this.chart,
                        ...
                        c = (b.exportSVGElements && b.exportSVGElements[0])
                            .element;
                    b.openMenu
                ...
                function d() {
                    ...
                    a &&
                        ...
                        (a.forEach(function (a) {
                            if (
                                a &&
                                "highcharts-menu-item" === a.className &&
                                a.onmouseout
                            )
        ...
        function (a, h, p, w, q) {
            ...
            p = (function () {
                ...
                a.prototype.updateExitAnchor = function () {
                    var a = "highcharts-end-of-chart-marker-".concat(
                        this.chart.index
                    );
                    a = n(a);
                    this.removeExitAnchor();
                ...
                a.prototype.move = function (a) {
                    ...
                    if (
                        (c = this.modules && this.modules[this.currentModuleIx])
                    ) {
                ...
                a.prototype.onFocus = function (a) {
                    ...
                    a =
                        a.relatedTarget &&
                        c.container.contains(a.relatedTarget);
                    this.exiting ||
                ...
                a.prototype.onKeydown = function (a) {
                    ...
                    if (c) {
                        ...
                        b === c.response.success
                            ...
                            : b === c.response.prev
                            ? (d = this.move(-1))
                            : b === c.response.next && (d = this.move(1));
    ...
    x(
        ...
        function (a, h, p, w, q, l, G, v) {
            ...
            function n(a, d) {
                ...
                ["legendGroup", "legendItem", "legendSymbol"].forEach(function (
                    c
                ) {
                    (c = ((c = d[c]) && c.element) || c) &&
                        b(c, a ? "mouseover" : "mouseout");
                });
            }
            var k =
                    (this && this.__extends) ||
            ...
            a = (function (a) {
                ...
                b.prototype.init = function () {
                    ...
                    this.addEvent(p, "afterScroll", function () {
                        this.chart === a.chart &&
                            (a.proxyProvider.updateGroupProxyElementPositions(
                                "legend"
                            ),
                    ...
                    this.addEvent(p, "afterRender", function () {
                        this.chart === a.chart &&
                            this.chart.renderer &&
                            a.recreateProxies() &&
                            z(function () {
                                ...
                                y(this.chart.renderer.globalAnimation, !0)
                            ).duration);
                    });
                };
                b.prototype.updateLegendItemProxyVisibility = function () {
                    ...
                    (b.allItems || []).forEach(function (f) {
                        if (f.a11yProxyElement) {
                            ...
                            m
                                ? a.styledMode
                                    ? F(r, "highcharts-a11y-invisible")
                                    : (r.style.visibility = "hidden")
                                : (B(r, "highcharts-a11y-invisible"),
                                  (r.style.visibility = ""));
                        }
                    });
                };
                    ...
                    if (0 < a && a <= c.length) {
                        ...
                        for (var f = 0; f < c; ++f)
                            if (d.allItems[f].pageIx + 1 === a) {
                                b.highlightLegendItem(f) &&
                                    (this.highlightedLegendItemIx = f);
                                break;
                            }
                    }
                };
                ...
                b.prototype.updateLegendTitle = function () {
                    ...
                    a = a.langFormat(
                        "accessibility.legend.legendLabel" +
                            (b ? "" : "NoTitle"),
                        { chart: a, legendTitle: b, chartTitle: t(a) }
                    );
                ...
                b.prototype.onKbdArrowKey = function (a, b) {
                    ...
                    if (f.highlightLegendItem(this.highlightedLegendItemIx + b))
                        return (this.highlightedLegendItemIx += b), c.success;
            ...
            (function (a) {
                function b(a) {
                    ...
                    return c
                        ? (f(d) && b[d] && n(!1, b[d]),
                          ...
                          (b =
                              c.a11yProxyElement &&
                              c.a11yProxyElement.buttonElement),
                ...
                a.compose = function (a, f) {
                    -1 === e.indexOf(a) &&
                        (e.push(a), (a.prototype.highlightLegendItem = b));
                    -1 === e.indexOf(f) &&
                        (e.push(f), d(f, "afterColorizeItem", c));
                };
            })(a || (a = {}));
            return a;
        }
    ...
    x(
        ...
        function (a, h, p, w, q) {
            function l(a) {
                var b = a.index;
                return a.series && a.series.data && m(b)
                    ? D(a.series.data, function (a) {
                          return !!(
                              a &&
            ...
            function t(a) {
                var b =
                    a.chart.options.accessibility.series
            ...
            function g(a) {
                var b =
                    a.chart.options.accessibility.keyboardNavigation
                        .seriesNavigation;
                return !(
                    !a.points ||
                    !(
            ...
            function c(a, b) {
                return a.chart.langFormat(
                    "accessibility.series." + b + "Description",
                    { name: z(a[b]), series: a }
                );
            }
            function e(a, b, d) {
            ...
            function d(a) {
                ...
                r =
                    (r && r.point && r.point.valueDescriptionFormat) ||
                    ...
                    (g = g.xAxis && g.xAxis.dateTime)
                        ? ((g = g.getXDateFormat(
                          ...
                          (z =
                              ...
                              h.dateFormat ||
                              g),
                          (k = k.time.dateFormat(z, a.x || 0, void 0)))
                        : (k = void 0);
                    z =
                ...
                var l = h.chart.options.accessibility.point || {},
                    p =
                        (h.chart.options.accessibility &&
                            h.chart.options.accessibility.point) ||
                        {},
                    E = h.tooltipOptions || {};
                    ...
                    a.points.forEach(function (c) {
                        ...
                        if (!(e = c.graphic && c.graphic.element)) {
                            ...
                            if ((e = c.isNull && !r && e)) {
                                ...
                                m = m
                                    ? {
                                          x: u(c.plotX, m.plotX, 0),
                                          y: u(c.plotY, m.plotY, 0),
                                      }
                                    : { x: u(c.plotX, 0), y: u(c.plotY, 0) };
                                m = c.series.chart.renderer.rect(
                                    m.x,
                                    m.y,
                                    1,
                                    1
                                  ...
                                  b && !r
                                      ? ((m = c.series),
                                        ...
                                        (m =
                                            ...
                                            {}),
                                        (c = C(
                                            (m.descriptionFormatter &&
                                                m.descriptionFormatter(c)) ||
            ...
            function f(a) {
                var b = a.chart,
                    ...
                    r = c(a, "xAxis"),
                    g = c(a, "yAxis"),
                    y = { seriesNumber: m, series: a, chart: b };
                d = 1 < d.length ? "Combination" : "";
                y =
                    b.langFormat(
                        "accessibility.series.summary." + a.type + d,
                        y
                    ) ||
                    b.langFormat("accessibility.series.summary.default" + d, y);
                e =
                    (e("yAxis") ? " " + g + "." : "") +
                    (e("xAxis") ? " " + r + "." : "");
                return B(
            ...
            var y = a.getPointAnnotationTexts,
                ...
                B = p.format,
                A = p.numberFormat,
                E = w.reverseChildNodes,
                C = w.stripHTMLTagsFromString,
                D = q.find,
                L = q.isNumber,
                u = q.pick,
                m = q.defined;
            return {
                ...
                describeSeries: function (a) {
                    ...
                    if (e) {
                        ...
                        var r = (a.options.accessibility || {})
                            .exposeAsGroupOnly;
                        (d.options3d && d.options3d.enabled && c) ||
                        !(c || m || r || t(a))
        ...
        function (a, h, p, w, q, l) {
            ...
            h = (function () {
                ...
                d.prototype.init = function () {
                    var a = this.chart,
                        d = a.options.accessibility.announceNewData
                            .interruptUser
                            ? "assertive"
                            : "polite";
                    this.lastAnnouncementTime = 0;
                ...
                d.prototype.onSeriesAdded = function (a) {
                    this.chart.options.accessibility.announceNewData.enabled &&
                        ...
                        (this.dirty.newSeries = n(this.dirty.newSeries)
                            ? void 0
                            : a));
                };
                ...
                d.prototype.queueAnnouncement = function (a, d, c) {
                    ...
                    if (e.enabled) {
                        ...
                        e = Math.max(
                            0,
                            e.minAnnounceInterval -
                                (f - this.lastAnnouncementTime)
                        );
                        a = v(
                                    ...
                                    function () {
                                        b &&
                                            ...
                                            ((b.lastAnnouncementTime =
                                                +new Date()),
                                            b.announcer.announce(
                                                b.queuedAnnouncement.message
                                            ),
                ...
                d.prototype.buildAnnouncementMessage = function (b, d, g) {
                    var f = this.chart,
                        y = f.options.accessibility.announceNewData;
                    if (
                        y.announcementFormatter &&
                        ((b = y.announcementFormatter(b, d, g)), !1 !== b)
                    )
            ...
            (function (a) {
                function b(a) {
                    ...
                    d &&
                        ...
                        (d.dirty.newPoint = n(d.dirty.newPoint)
                            ? void 0
                            : a.point);
                }
                function d() {
    ...
    x(
        ...
        function (a, h, p, w, q) {
            var l = a.doc,
                ...
                v = h.css,
                g = h.merge,
                n = w.fireEventOnWrappedOrUnwrappedElement,
                k = q.cloneMouseEvent,
                c = q.cloneTouchEvent,
            ...
            return (function () {
                function a(a, b, d, c) {
                    ...
                    e
                        ? (d && !a.styledMode && (e.style.listStyle = "none"),
                          e.appendChild(f),
                          (this.element = e))
                        : (this.element = f);
        ...
        function (a, h, p, w, q, l) {
            ...
            return (function () {
                ...
                a.prototype.clearGroup = function (a) {
                    ...
                    if (!b)
                        throw Error(
                            "ProxyProvider.clearGroup: Invalid group key " + a
                        );
                ...
                a.prototype.createProxyPosContainer = function (a) {
                    ...
                    b.className =
                        "highcharts-a11y-proxy-container" + (a ? "-" + a : "");
                    g(b, { top: "0", left: "0" });
                    this.chart.styledMode ||
            ...
            var C = (function () {
                ...
                f.prototype.clickButton = function (b, d) {
                    var e = this.chart,
                        ...
                        k = r.dataMin,
                        h = r.dataMax,
                        n = f && Math.round(Math.min(f.max, B(h, f.max))),
                        u = m.type;
                    r = m._range;
                    var l,
                        p = m.dataGrouping;
                    ...
                    if (null !== k && null !== h) {
                        ...
                        if ("month" === u || "year" === u)
                            ...
                            "all" === u &&
                                ...
                                (e.navigator &&
                                    ...
                                    (e.navigator.baseSeries[0].xAxis.options.range =
                                        void 0),
                                (A = k),
                                (n = h));
                        ...
                        if (f)
                            f.setExtremes(A, n, B(d, !0), void 0, {
                ...
                f.prototype.init = function (a) {
                    ...
                    this.eventsToUnbind.push(
                        g(a, "load", function () {
                            a.xAxis &&
                                a.xAxis[0] &&
                                g(a.xAxis[0], "setExtremes", function (d) {
                ...
                f.prototype.updateButtonStates = function () {
                    ...
                    a.buttonOptions.forEach(function (b, m) {
                        ...
                        ("month" === g || "year" === g) &&
                        e + 36e5 >=
                            864e5 * { month: 28, year: 365 }[g] * I - M &&
                        e - 36e5 <= 864e5 * { month: 31, year: 366 }[g] * I + M
                            ? (r = !0)
                            : "ytd" === g
                            ? ((r = u - n + M === e), (E = !b))
                            : "all" === g &&
                        ...
                        N.state !== H &&
                            (N.setState(H),
                            d &&
                                ((d.options[m + 1].disabled = g),
                                2 === H && (d.selectedIndex = m + 1)),
                            0 === H && y === m && a.setSelected());
                    });
                };
                ...
                f.prototype.setInputValue = function (a, b) {
                    ...
                    if (f) {
                        ...
                        f.value = e.dateFormat(
                            this.inputTypeFormats[f.type] ||
                                d.inputEditDateFormat,
                            m
                        );
                        a &&
                            a.attr({
                                  ...
                                  left:
                                      Math.min(
                                          Math.round(
                                              b.x +
                                                  e -
                                                  (a.offsetWidth - b.width) / 2
                                          ),
                                          this.chart.chartWidth - a.offsetWidth
                                      ) + "px",
                                  top:
                                      c -
                                      (a.offsetHeight - b.height) / 2 +
                                      "px",
                              });
                    }
                };
                ...
                f.prototype.defaultInputDateParser = function (a, b, d) {
                    ...
                    z(c) ||
                        ((a = a.split("-")),
                        (c = Date.UTC(A(a[0]), A(a[1]) - 1, A(a[2]))));
                ...
                f.prototype.drawInput = function (a) {
                    function d() {
                        ...
                        b !== Number(q.getAttribute("data-hc-time-previous")) &&
                            z(b) &&
                            (q.setAttribute("data-hc-time-previous", b),
                            y && r && z(f)
                                ? b > Number(r.getAttribute("data-hc-time"))
                                    ? (b = void 0)
                                    : b < f && (b = f)
                                : g &&
                                  z(e) &&
                    ...
                    var c = this.chart,
                        ...
                        l =
                            v.lang[
                                y ? "rangeSelectorFrom" : "rangeSelectorTo"
                            ] || "";
                    l = h
                        .label(l, 0)
                    ...
                    c.styledMode ||
                        (l.css(x(g, u.labelStyle)),
                        h.css(x({ color: "#333333" }, g, u.inputStyle)),
                        k(
                            q,
                            b(
                                {
                ...
                f.prototype.render = function (a, b) {
                    ...
                    if (!1 !== r.enabled) {
                        this.rendered ||
                            ...
                            f.parentNode &&
                                f.parentNode.insertBefore(this.div, f),
                            m &&
                                ((this.inputGroup = e
                                    .g("input-group")
                                    .add(this.group)),
                ...
                f.prototype.renderButtons = function () {
                    ...
                    [
                        [p.isMS ? "mouseover" : "mouseenter"],
                        [p.isMS ? "mouseout" : "mouseleave"],
                        ["change", "click"],
                    ].forEach(function (d) {
                        var c = d[0],
                            e = d[1];
                    ...
                    this.chart.styledMode ||
                        ...
                        (f["stroke-width"] = B(f["stroke-width"], 0)));
                    n(
                        "option",
                    ...
                    this.buttonOptions.forEach(function (d, c) {
                        ...
                        b[c] = e
                            ...
                            .attr({ "text-align": "center", width: h })
                            .add(a.buttonGroup);
                    ...
                    if (e && h && n) {
                        ...
                        "bottom" === y &&
                            ((l =
                                ...
                                l.enabled &&
                                !l.floating
                                    ? c.legend.legendHeight + B(l.margin, 10)
                                    : 0),
                            (b = b + l - 20),
                            (l =
                                f -
                        ...
                        g.inputEnabled &&
                            h &&
                            n &&
                            ((h.style.marginTop = e.translateY + "px"),
                            (n.style.marginTop = e.translateY + "px"));
                ...
                f.prototype.handleCollision = function (a) {
                    ...
                    var h = function (b) {
                            if (e && c) {
                                var d =
                                    ...
                                    m = c.alignAttr.translateX + c.getBBox().x;
                                return (
                                    m + b > d &&
                                    d + f > m &&
                                    g.y < k.y + e.getBBox().height
                                );
                            }
                            return !1;
                        },
                        n = function () {
                            e &&
                                ...
                                e.attr({
                                    translateX:
                                        e.alignAttr.translateX +
                                        (d.axisOffset[1] >= -a ? 0 : -a),
                                    translateY:
                                        e.alignAttr.translateY +
                                        c.getBBox().height +
                                        10,
                                });
                        };
                    ...
                    e && c
                        ? k.align === g.align ||
                          h(this.initialButtonGroupWidth + 20)
                            ? "responsive" === m
                                ? (this.collapseButtons(a), h(f()) && n())
                                : n()
                            : "responsive" === m && this.expandButtons()
                        : c &&
                          "responsive" === m &&
                    ...
                    var b = this.buttons,
                        ...
                        k = function (a) {
                            return {
                                ...
                                width: "auto",
                                paddingLeft: B(
                                    f.buttonTheme.paddingLeft,
                                    m.padding,
                                    8
                                ),
                                paddingRight: B(
                                    f.buttonTheme.paddingRight,
                                    m.padding,
                                    8
                                ),
                            };
                ...
                f.prototype.hideDropdown = function () {
                    var a = this.dropdown;
                    a &&
                        (k(a, { top: "-9999em", width: "1px", height: "1px" }),
            ...
            a.prototype.minFromRange = function () {
                ...
                f <= k &&
                    ...
                    (this.newMax = Math.min(
                        f + g,
                        B(this.dataMax, Number.MAX_VALUE)
                    )));
                z(d)
                    ? !z(a) && a && a._offsetMin && (f += a._offsetMin)
                    : (f = void 0);
                return f;
            };
            if (!p.RangeSelector) {
                ...
                g(h, "beforeRender", function () {
                    ...
                    b &&
                        (z(b.deferredYTDClick) &&
                            (b.clickButton(b.deferredYTDClick),
                ...
                g(h, "update", function (a) {
                    ...
                    b &&
                        ...
                        (this.rangeSelector = a = new C(this)));
                    ...
                    a &&
                        ...
                        this.extraBottomMargin !== d ||
                            this.extraTopMargin !== e) &&
                        (this.isDirtyBox = !0);
                });
                g(h, "render", function () {
    ...
    x(
        ...
        function (a, h, p, w, q, l) {
            var t =
                ...
                v = p.unhideChartElementFromAT,
                g = p.getAxisRangeDescription,
                n = l.addEvent,
                k = l.attr;
            h = (function (a) {
                function c() {
                ...
                c.prototype.onChartUpdate = function () {
                    ...
                    c &&
                        ...
                        c.maxInput &&
                            c.minInput &&
                            ["minInput", "maxInput"].forEach(function (d, e) {
                                if ((d = c[d]))
                                    v(a, d),
                ...
                c.prototype.setRangeInputAttrs = function (a, b) {
                    ...
                    k(a, {
                        tabindex: -1,
                        "aria-label": c.langFormat(b, { chart: c }),
                    });
                };
                c.prototype.onButtonNavKbdArrowKey = function (a, b) {
                    var c = a.response,
                        ...
                        e = this.chart,
                        g =
                            e.options.accessibility.keyboardNavigation
                                .wrapAround;
                    b = b === d.left || b === d.up ? -1 : 1;
                ...
                c.prototype.onButtonNavKbdClick = function (a) {
                    ...
                    3 !== b.oldRangeSelectorItemState &&
                        this.fakeClickEvent(
                            b.rangeSelector.buttons[
                                b.highlightedRangeSelectorItemIx
                            ].element
                        );
                    return a.success;
                };
                ...
                c.prototype.initDropdownNav = function () {
                    ...
                    c &&
                        ...
                        this.removeDropdownKeydownHandler &&
                            this.removeDropdownKeydownHandler(),
                        (this.removeDropdownKeydownHandler = n(
                            e,
                            "keydown",
                            function (c) {
                        ...
                        init: function (b) {
                            ...
                            d && d.hasVisibleDropdown
                                ...
                                : d &&
                                  ...
                                  a.highlightRangeSelectorButton(
                                      0 < b ? 0 : d
                                  ));
                        },
                        terminate: function () {
            ...
            (function (c) {
                ...
                c.compose = function (c, g) {
                    -1 === b.indexOf(c) &&
                        (b.push(c),
                        (c.prototype.highlightRangeSelectorButton = e));
                    -1 === b.indexOf(g) &&
                        (b.push(g), n(a, "afterBtnClick", d));
                };
            })(h || (h = {}));
            return h;
        }
    ...
    x(
        ...
        function (a, h, p, w, q, l, x, v) {
            ...
            function k(a) {
                ...
                return (
                    (a.isNull &&
                        b.keyboardNavigation.seriesNavigation.skipNullPoints) ||
                    !1 === a.visible ||
                    !1 === a.isInside ||
                    c ||
                    n(a.series)
            ...
            p = (function () {
                ...
                b.prototype.onKbdVertical = function (a, b) {
                    ...
                    d =
                        c.options.accessibility.keyboardNavigation
                            .seriesNavigation;
                    if (d.mode && "serialize" === d.mode)
                        return this.attemptHighlightAdjacentPoint(a, b);
                    c[
                        c.highlightedPoint &&
                        c.highlightedPoint.series.keyboardMoveVertical
            ...
            (function (a) {
                function c(a) {
                    ...
                    if (c) {
                        if (
                            ...
                            !d &&
                                b &&
                                (d = b.points[a ? 0 : b.points.length - 1]),
                            !d)
                        )
                            return !1;
                ...
                function h(a) {
                    ...
                    this.graphic &&
                        ...
                        !a &&
                            b.focusElement &&
                            b.focusElement.removeFocusBorder());
                ...
                a.compose = function (a, f, g) {
                    ...
                    -1 === m.indexOf(f) &&
                        (m.push(f), (f.prototype.highlight = h));
                    -1 === m.indexOf(g) &&
                        (m.push(g),
                        (f = g.prototype),
            ...
            return (function (a) {
                ...
                c.prototype.onChartRender = function () {
                    this.chart.series.forEach(function (a) {
                        !1 !==
                            (a.options.accessibility &&
                                a.options.accessibility.enabled) && a.visible
                            ? n(a)
                            : g(a);
                    });
                };
            ...
            return (function (a) {
                ...
                g.prototype.onChartUpdate = function () {
                    var a = this.chart,
                        c = this;
                    a.mapNavigation &&
                        a.mapNavigation.navButtons.forEach(function (e, d) {
                            l(a, e.element);
                ...
                g.prototype.updateProxyOverlays = function () {
                    ...
                    a.resetZoomButton &&
                        this.createZoomProxyButton(
                            ...
                            a.langFormat("accessibility.zoom.resetZoomButton", {
                                chart: a,
                            })
                        );
                    a.drillUpButton &&
                ...
                g.prototype.createZoomProxyButton = function (a, c, e) {
                    this[c] = this.proxyProvider.addProxyElement(
                        "zoom",
                        { click: a },
                    ...
                    return new p(c, {
                        ...
                        validate: function () {
                            return !!(
                                c.mapZoom &&
                                c.mapNavigation &&
                                c.mapNavigation.navButtons.length
                            );
                        },
                        init: function (a) {
        ...
        function (a) {
            ...
            return {
                isHighContrastModeActive: function () {
                    ...
                    if (t.matchMedia && a)
                        return t.matchMedia("(-ms-high-contrast: active)")
                            .matches;
                    if (p && t.getComputedStyle) {
                        ...
                        var l = (a.currentStyle || t.getComputedStyle(a))
                            .backgroundImage;
                    ...
                    return (
                        t.matchMedia &&
                        t.matchMedia("(forced-colors: active)").matches
                    );
                },
            ...
            h = (function () {
                ...
                a.prototype.init = function (a) {
                    ...
                    t.addEventListener && a.renderer.isSVG
                        ? (F(a),
                          (this.proxyProvider = new e(this.chart)),
                          this.initComponents(),
                ...
                a.prototype.initComponents = function () {
                    ...
                    e.customComponents &&
                        E(this.components, e.customComponents);
            ...
            (function (a) {
                ...
                function h(a) {
                    if ((a = a.options.accessibility))
                        a.customComponents &&
                            ...
                            D(!0, this.options.accessibility, a),
                            this.accessibility &&
                ...
                function l() {
                    ...
                    c && c.enabled
                        ? b && !b.zombie
                            ? b.update()
                            : ((this.accessibility = b = new a(this)),
                              !b.zombie) && b.update()
                        : b
                ...
                a.compose = function (a, m, r, u, v, w, y) {
                    ...
                    -1 === t.indexOf(m) &&
                        (t.push(m),
                        (m.prototype.updateA11yEnabled = l),
                        A(m, "destroy", e),
                        A(m, "render", f),
                        A(m, "update", h),
