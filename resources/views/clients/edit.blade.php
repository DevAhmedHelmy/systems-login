        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Update: {{ $client->name }}</h4>
                </div>
                <div class="card-body">
                    <form class="form form-vertical" method="POST" action="{{ route('clients.update', $client) }}">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="name"
                                        ...
                                        placeholder="Client Name" value="{{ $client->name }}" required>
                                </div>
                                @error('name')
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="domain"
                                        ...
                                        placeholder="Client Domain" value="{{ $client->domain }}" required>
                                </div>
                                @error('domain')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="api_key"
                                        ...
                                        placeholder="Api key" value="{{ $client->api_key }}">
                                </div>
                                @error('api_key')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="select2 form-select @error('users') is-invalid @enderror" multiple
                                        ...
                                        @foreach ($users as $user)
                                            <option @selected($user->clients->contains($client)) value="{{ $user->id }}">
                                                {{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('users')
